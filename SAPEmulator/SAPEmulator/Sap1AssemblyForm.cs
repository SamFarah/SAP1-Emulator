...
{
    public partial class Sap1AssemblyForm : Form
    {
        public Sap1AssemblyForm()
        {
            InitializeComponent();
        }
        private Sap1SimulationForm mainForm = null;
        public Sap1AssemblyForm(Form callingForm)
        {
            mainForm = callingForm as Sap1SimulationForm ;
            InitializeComponent();
        }
